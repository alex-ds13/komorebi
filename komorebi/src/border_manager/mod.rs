...
pub struct WindowKindColours {
    ...
    pub unfocused_locked_colour: u32,
...
impl Default for WindowKindColours {
    fn default() -> Self {
        Self {
            ...
            unfocused_locked_colour: u32::from(Colour::Rgb(Rgb::new(158, 8, 8))),
...
impl WindowKindColours {
    ...
    pub fn from_kind(&self, window_kind: WindowKind) -> u32 {
        match window_kind {
            ...
            WindowKind::UnfocusedLocked => self.unfocused_locked_colour,
    ...
    pub fn update(
        ...
        match message {
            BorderMessage::Update(tracking_hwnd) => {
                self.handle_border_update(wm_info, tracking_hwnd, false)
            }
            BorderMessage::ForceUpdate => self.handle_border_update(wm_info, None, true),
        ...
        match self.border_implementation {
            ...
            BorderImplementation::Komorebi => {
                ...
                if !forced_update {
                    ...
                    if !should_process_notification
                        && let Some(previous) = previous_tracking_hwnd
                        && *previous != tracking_hwnd.unwrap_or_default()
                    {
                        should_process_notification = true;
                    }
                };
...
/// Sends an `BorderMessage::ForceUpdate` to the runtime to force update all the borders
